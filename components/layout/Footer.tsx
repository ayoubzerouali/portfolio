          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-400">
                <Link href="mailto:contact@example.com" className="hover:text-primary-400 transition-colors">
                  contact@example.com
                </Link>
              </li>
              <li className="text-gray-400">
                <Link href="tel:+1234567890" className="hover:text-primary-400 transition-colors">
                  +1 (234) 567-890
                </Link>
              </li>
            </ul>
